...
namespace RomajiSongName.Data;

internal static class SongNames
{
    // Sorted by album uid
    public static readonly Dictionary<string, string> RomajiNames =
        new()
        {
            // Default Songs Pack
            ...
            ["43-59"] = "HEARTBEAT！Kyun Kyun！iKz feat.Warma",
